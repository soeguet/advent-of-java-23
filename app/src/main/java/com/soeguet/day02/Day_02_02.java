...
public class Day_02_02 {
    ...
    public Day_02_02() {
        ...
        AtomicLong maxPower = new AtomicLong(0);
        ...
        lines.forEach(line -> {
            ...
            String[] gameIdArray = splitValue(gameAndRounds[0].trim());
        ...
        gameList.stream().forEach(g -> {
            ...
            maxPower.getAndAdd(g.getPower());
        });

        System.out.println(maxPower.get());
    }
